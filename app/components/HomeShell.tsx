          ...
          <div className="mt-20 grid gap-4 lg:mt-28 lg:grid-cols-3">
            {services.map((service, index) => (
              <Reveal key={service.title} delay={index * 90} className="h-full">
                <article className={`premium-panel premium-panel-${service.mark} group h-full min-h-[27rem] rounded-[1.75rem] border border-[#E7DCC1]/10 bg-[#151615] p-7 sm:p-9 lg:min-h-[32rem]`}>
