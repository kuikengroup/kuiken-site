  ...
  return (
    <div className="min-h-screen bg-[#0D0D0D] text-[#E7DCC1] scroll-smooth">
      <main className="[&_section]:animate-in [&_section]:fade-in-0 [&_section]:slide-in-from-bottom-4 [&_section]:duration-700">
        <section className="mx-auto grid max-w-7xl gap-10 px-8 pt-4 pb-12 lg:grid-cols-[1.1fr_0.9fr] lg:px-12 lg:pt-6 lg:pb-16">
          <div className="max-w-3xl">
            <div className="mb-6 text-[11px] uppercase tracking-[0.34em] text-[#C6A972]">
              Brand Strategy • Digital Marketing • Lead Generation
            </div>

            <h1 className="max-w-4xl text-5xl font-semibold leading-[1.03] tracking-[-0.04em] text-[#E7DCC1] md:text-7xl">
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              ...
              <a
                href="#services"
                className="rounded-full border border-[#C6A972]/40 bg-transparent px-7 py-3 text-[12px] font-medium uppercase tracking-[0.2em] text-[#E7DCC1] transition duration-200 hover:-translate-y-0.5 hover:border-[#C6A972] hover:text-[#C6A972] inline-block"
              >
                View Capabilities
              </a>
            </div>

            <div className="mt-12 grid max-w-2xl grid-cols-1 gap-6 border-t border-[#E7DCC1]/10 pt-8 md:grid-cols-3">
              {[
                ...
                <div key={title}>
                  <div className="text-[11px] uppercase tracking-[0.22em] text-[#C6A972]">{title}</div>
                  <p className="mt-3 text-sm leading-6 text-[#E7DCC1]/65">{copy}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="relative">
            <div className="absolute -left-6 top-10 hidden h-24 w-24 rounded-full bg-[#C6A972]/10 blur-2xl lg:block" />
              ...
              <div className="rounded-[1.5rem] border border-[#E7DCC1]/10 bg-[#0D0D0D] p-8">
                <div className="flex items-start justify-between gap-6">
                  <div>
                    ...
                    <div className="mt-4 max-w-sm text-3xl font-semibold leading-tight tracking-[-0.03em] text-[#E7DCC1]">
                ...
                <div className="mt-10 space-y-4">
                  {[
                    ...
                    <div key={item} className="flex items-center gap-3 rounded-2xl border border-[#E7DCC1]/10 bg-[#252625] px-4 py-4">
        ...
        <section id="about" className="border-t border-[#E7DCC1]/10 bg-[#252625]">
          <div className="mx-auto grid max-w-7xl gap-12 px-8 py-14 lg:grid-cols-[0.8fr_1.2fr] lg:px-12">
            <div>
              <div className="text-[11px] uppercase tracking-[0.32em] text-[#C6A972]">About</div>
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <p className="text-base leading-8 text-[#E7DCC1]/70">
        ...
        <section id="services" className="mx-auto max-w-7xl px-8 py-14 lg:px-12">
          <div className="mb-10 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
              <div className="text-[11px] uppercase tracking-[0.32em] text-[#C6A972]">Services</div>
              <h2 className="mt-4 text-3xl font-semibold tracking-[-0.03em] text-[#E7DCC1] md:text-4xl">
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            {[
              ...
              <div key={item.title} className="rounded-[2rem] border border-[#E7DCC1]/10 bg-[#252625] p-8 shadow-[0_10px_35px_rgba(0,0,0,0.28)]">
                <div className="text-[11px] uppercase tracking-[0.28em] text-[#C6A972]">{item.label}</div>
                <h3 className="mt-5 text-2xl font-semibold tracking-[-0.03em] text-[#E7DCC1]">{item.title}</h3>
                <p className="mt-4 text-sm leading-7 text-[#E7DCC1]/65">{item.copy}</p>
              </div>
            ))}
          </div>
        </section>

        <section id="approach" className="border-y border-[#E7DCC1]/10 bg-[#252625]">
          <div className="mx-auto max-w-7xl px-8 py-14 lg:px-12">
            <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr]">
              <div>
                <div className="text-[11px] uppercase tracking-[0.32em] text-[#C6A972]">Approach</div>
                <h2 className="mt-4 text-3xl font-semibold tracking-[-0.03em] text-[#E7DCC1] md:text-4xl">
              ...
              <div className="grid gap-5">
                {[
                  ...
                  <div key={title} className="rounded-[1.75rem] border border-[#E7DCC1]/10 bg-[#0D0D0D] px-6 py-6">
                    <div className="text-[12px] font-semibold uppercase tracking-[0.18em] text-[#C6A972]">{title}</div>
                    <p className="mt-3 text-sm leading-7 text-[#E7DCC1]/65">{copy}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        <section id="contact" className="mx-auto max-w-7xl px-8 pt-10 pb-14 lg:px-12 lg:pt-12">
          <div className="rounded-[2rem] bg-[#252625] px-8 py-12 text-[#E7DCC1] shadow-[0_24px_70px_rgba(0,0,0,0.35)] md:px-12 md:py-14 border border-[#E7DCC1]/10">
            <div className="grid gap-8 md:grid-cols-[1.2fr_0.8fr] md:items-start">
              <div>
                ...
                <p className="mt-5 max-w-2xl text-base leading-8 text-[#E7DCC1]/70">
                  Start a conversation with Kuiken Group to discuss your brand, website, marketing goals, or growth priorities.
                </p>
              </div>

              <div className="space-y-4 rounded-[1.5rem] border border-[#E7DCC1]/10 bg-[#0D0D0D] p-6">
                <div className="text-sm text-[#E7DCC1]/70">Brady Kuiken</div>
                <div className="text-lg font-medium text-[#E7DCC1]">President / CEO</div>
                ...
                <form action="https://formspree.io/f/mgoprpew" method="POST" className="space-y-3 pt-2">
                  <input
                    ...
                    required
                    className="w-full rounded-lg border border-[#E7DCC1]/10 bg-[#252625] px-4 py-2 text-sm text-[#E7DCC1] placeholder-[#E7DCC1]/45 outline-none"
                  />
                  <input
                    type="email"
                    name="email"
                ...
                <div className="pt-2 text-sm text-[#E7DCC1]/75">brady@kuikengroup.com</div>
